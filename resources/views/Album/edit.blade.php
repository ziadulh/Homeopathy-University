        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <h3 class="card-title">Edit Albam </h3>
                    </div>

                    <form role="form" action="{{route('album.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group" id="t">
                                ...
                                <img src="{{  asset('/Photos/Album/'.$data->photo)  }}" height="100px" width="100px">
