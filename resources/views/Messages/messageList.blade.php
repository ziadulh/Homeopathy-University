                        ...
                        <tr>
                            <td>
                                <form action="{{route('message.destroy',$data->id)}}" method="post" >
                                    ...
                                    <a class="btn btn-primary alert-success fas fa-edit" href="{{route('message.edit',$data->id)}}"></a>
                                </form>
                            </td>
                            <td>{{$key+1}}</td>
                            ...
                            <td>{{$data->title}}</td>
                            {{--  <td>{!! $data->message !!}</td>  --}}
                            <td><img src="{{  asset('/Photos/Messenger/'.$data->photo)  }}" height="100px" width="100px"></td>
                        </tr>
